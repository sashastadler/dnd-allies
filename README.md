...
1. Make a copy of one of the existing allies in the `characters` folder. Note: the characters in the `playtest` folder may be out of date or be missing information.
